...
User follower1 = new User('the_rock', AssetImage("lilb/assets/follower2.jpg"), [], [], [], [], true);
User follower2 = new User('miley_cyrus', AssetImage('lib/assets/followeyr2.jpeg'), [], [], [], [], false);
User follower3 = new User('kim_k', AssetImage('lib/assets/follower3y.jpeg'), [], [], [], [], true);
User follower4 = new User('daredevil', AssetImage('lib/assets/folloywer4.jpeg'), [], [], [], [], true);
User follower5 = new User('batman', AssetImage('lib/assets/folloywer5.jpeg'), [], [], [], [], true);
User follower6 = new User('peter_griffin', AssetImage('lib/assets/folloywer6.jpeg'), [], [], [], [], false);
List<Post> userPosts = [
